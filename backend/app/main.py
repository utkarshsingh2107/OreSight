...
from .routers import mines, production, forecast, actions, reports, reserve, admin, prospectivity, weather
...
app.include_router(prospectivity.router, prefix="/api", tags=["prospectivity"])
