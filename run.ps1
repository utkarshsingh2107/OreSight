...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location -Path '$PWD\backend'; uvicorn app.main:app --reload --port 8000"
...
Write-Host ""
Write-Host "===========================================" -ForegroundColor Green
Write-Host "[OK] OreSight is starting!" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "[READY] Ready for demo!" -ForegroundColor Green
